...
function Clock() {
    ...
    const formatterTime = new Intl.DateTimeFormat('ru-RU', {hour: 'numeric', minute: 'numeric', second: 'numeric'})
    const formatterDate = new Intl.DateTimeFormat('ru-RU', {day: 'numeric', month:'numeric', year:'numeric'})
    ...
    const formatterDay = new Intl.DateTimeFormat('en-EN', {weekday: 'long'})
    const formatterMonth = new Intl.DateTimeFormat('en-EN', {month: 'long'})
